...
class ScenarioRunnerIntegrationTest {
  ...
  @Test
  void terminalAuthScenarioSkipsIssuerReuse() throws Exception {
    ...
    assertNull(resolved, "Terminal authentication scenarios should not reuse issuer personalization");
  }
